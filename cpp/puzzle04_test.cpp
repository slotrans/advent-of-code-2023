...
ScratchCard card1 = {.cardNum=1, .copies=1, .winningNumbers={41, 48, 83, 86, 17}, .numbersYouHave={83, 86,  6, 31, 17,  9, 48, 53}};
ScratchCard card2 = {.cardNum=2, .copies=1, .winningNumbers={13, 32, 20, 16, 61}, .numbersYouHave={61, 30, 68, 82, 17, 32, 24, 19}};
ScratchCard card3 = {.cardNum=3, .copies=1, .winningNumbers={ 1, 21, 53, 59, 44}, .numbersYouHave={69, 82, 63, 72, 16, 21, 14,  1}};
ScratchCard card4 = {.cardNum=4, .copies=1, .winningNumbers={41, 92, 73, 84, 69}, .numbersYouHave={59, 84, 76, 51, 58,  5, 54, 83}};
ScratchCard card5 = {.cardNum=5, .copies=1, .winningNumbers={87, 83, 26, 28, 32}, .numbersYouHave={88, 30, 70, 12, 93, 22, 82, 36}};
ScratchCard card6 = {.cardNum=6, .copies=1, .winningNumbers={31, 18, 13, 56, 72}, .numbersYouHave={74, 77, 10, 23, 35, 67, 36, 11}};
...
TEST_CASE("p2 game for sample", "[part2]") {
    REQUIRE( PlayP2Game("../input/sample04") == 30 );
}
